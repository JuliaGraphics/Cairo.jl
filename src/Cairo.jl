...
mutable struct CairoSurface{T<:Union{UInt32,RGB24,ARGB32}} <: GraphicsDevice
    ...
    @compat function (::Type{CairoSurface{T}})(ptr::Ptr{Cvoid}, w, h) where T
        self = new{T}(ptr, w, h)
        @compat finalizer(destroy, self)
        self
    end
    @compat function (::Type{CairoSurface{T}})(ptr::Ptr{Cvoid}, w, h, data::Matrix{T}) where T
        self = new{T}(ptr, w, h, data)
        @compat finalizer(destroy, self)
        self
    end
    @compat function (::Type{CairoSurface{T}})(ptr::Ptr{Cvoid}) where T
        ccall(
...
function destroy(surface::CairoSurface)
    ...
    ccall((:cairo_surface_destroy,_jl_libcairo), Nothing, (Ptr{Cvoid},), surface.ptr)
    surface.ptr = C_NULL
    nothing
end
...
function CairoImageSurface(img::Array{UInt32,2}, format::Integer; flipxy::Bool = true)
    ...
    ptr = ccall((:cairo_image_surface_create_for_data,_jl_libcairo),
                Ptr{Cvoid}, (Ptr{Cvoid},Int32,Int32,Int32,Int32),
...
function CairoPDFSurface(stream::T, w::Real, h::Real) where T <: IO
    ...
    ptr = ccall((:cairo_pdf_surface_create_for_stream,_jl_libcairo), Ptr{Cvoid},
                (Ptr{Cvoid}, Any, Float64, Float64), callback, stream, w, h)
    CairoSurface(ptr, w, h)
end

function CairoPDFSurface(filename::AbstractString, w_pts::Real, h_pts::Real)
    ptr = ccall((:cairo_pdf_surface_create,_jl_libcairo), Ptr{Cvoid},
...
function CairoEPSSurface(stream::T, w::Real, h::Real) where T <: IO
    callback = get_stream_callback(T)
    ptr = ccall((:cairo_ps_surface_create_for_stream,_jl_libcairo), Ptr{Cvoid},
                (Ptr{Cvoid}, Any, Float64, Float64), callback, stream, w, h)
    ccall((:cairo_ps_surface_set_eps,_jl_libcairo), Nothing,
        (Ptr{Cvoid},Int32), ptr, 1)
    CairoSurface(ptr, w, h)
end

function CairoEPSSurface(filename::AbstractString, w_pts::Real, h_pts::Real)
    ptr = ccall((:cairo_ps_surface_create,_jl_libcairo), Ptr{Cvoid},
                (Ptr{UInt8},Float64,Float64), @compat(String(filename)), w_pts, h_pts)
    ccall((:cairo_ps_surface_set_eps,_jl_libcairo), Nothing,
          (Ptr{Cvoid},Int32), ptr, 1)
    CairoSurface(ptr, w_pts, h_pts)
...
function CairoPSSurface(stream::IOStream, w::Real, h::Real)
    callback = cfunction(write_to_ios_callback, Int32, Tuple{Ptr{Cvoid},Ptr{UInt8},UInt32})
    ptr = ccall((:cairo_ps_surface_create_for_stream,_jl_libcairo), Ptr{Cvoid},
                (Ptr{Cvoid}, Ptr{Cvoid}, Float64, Float64), callback, stream, w, h)
    ccall((:cairo_ps_surface_set_eps,_jl_libcairo), Nothing,
        (Ptr{Cvoid},Int32), ptr, 0)
    CairoSurface(ptr, w, h)
end
...
function CairoXlibSurface(display, drawable, visual, w, h)
    ptr = ccall((:cairo_xlib_surface_create,_jl_libcairo), Ptr{Cvoid},
                (Ptr{Cvoid}, Int, Ptr{Cvoid}, Int32, Int32),
...
function CairoQuartzSurface(context, w, h)
    ptr = ccall((:cairo_quartz_surface_create_for_cg_context,_jl_libcairo),
          Ptr{Cvoid}, (Ptr{Cvoid}, UInt32, UInt32), context, w, h)
    CairoSurface(ptr, w, h)
end
...
function CairoSVGSurface(stream::T, w::Real, h::Real) where T <: IO
    callback = get_stream_callback(T)
    ptr = ccall((:cairo_svg_surface_create_for_stream,_jl_libcairo), Ptr{Cvoid},
                (Ptr{Cvoid}, Any, Float64, Float64), callback, stream, w, h)
    CairoSurface(ptr, w, h)
end

function CairoSVGSurface(filename::AbstractString, w::Real, h::Real)
    ptr = ccall((:cairo_svg_surface_create,_jl_libcairo), Ptr{Cvoid},
...
function read_from_png(filename::AbstractString)
    ptr = ccall((:cairo_image_surface_create_from_png,_jl_libcairo),
                Ptr{Cvoid}, (Ptr{UInt8},), @compat(String(filename)))
...
function write_to_png(surface::CairoSurface, stream::T) where T <: IO
    ...
    ccall((:cairo_surface_write_to_png_stream,_jl_libcairo), Nothing,
          (Ptr{UInt8},Ptr{Cvoid},Any), surface.ptr, callback, stream)
end
...
function read_from_png(stream::T) where T <: IO
    ...
    ptr = ccall((:cairo_image_surface_create_from_png_stream, Cairo._jl_libcairo),
                Ptr{Cvoid}, (Ptr{Cvoid},Ref{IO}), callback, stream)
...
function surface_create_similar(s::CairoSurface, w = width(s), h = height(s))
    ptr = ccall((:cairo_surface_create_similar,_jl_libcairo), Ptr{Cvoid},
...
mutable struct CairoScript <: GraphicsDevice
    ...
    function CairoScript(stream::T) where T<:IO
        callback = get_stream_callback(T)
        ptr = ccall((:cairo_script_create_for_stream,_jl_libcairo), Ptr{Cvoid},
                (Ptr{Cvoid}, Any), callback, stream)
        self = new(ptr)
        @compat finalizer(destroy, self)
        self
    end
...
function destroy(s::CairoScript)
    ...
    ccall((:cairo_device_destroy,_jl_libcairo), Nothing, (Ptr{Cvoid},), s.ptr)
    s.ptr = C_NULL
    nothing
end
...
function CairoScriptSurface(filename::AbstractString, w::Real, h::Real)
    ...
    ptr = ccall((:cairo_script_surface_create,_jl_libcairo), Ptr{Cvoid},
                (Ptr{Cvoid},Int32,Float64,Float64),s.ptr ,CONTENT_COLOR_ALPHA, w, h)
    CairoSurface(ptr, w, h)
end

function CairoScriptSurface(filename::AbstractString,sc::CairoSurface)
    s = CairoScript(filename)
    ptr = ccall((:cairo_script_surface_create_for_target,_jl_libcairo), Ptr{Cvoid},
                (Ptr{Cvoid},Ptr{Cvoid}),s.ptr, sc.ptr)
...
function CairoRecordingSurface(content::Int32,extents::CairoRectangle)
    ptr = ccall((:cairo_recording_surface_create,_jl_libcairo), Ptr{Cvoid},
                (Int32,Ptr{Cvoid}),content, Ref(extents))
    CairoSurface(ptr)
end
function CairoRecordingSurface(content::Int32)
    ptr = ccall((:cairo_recording_surface_create,_jl_libcairo), Ptr{Cvoid},
                (Int32,Ptr{Cvoid}),content, C_NULL)
    CairoSurface(ptr)
end
...
function script_from_recording_surface(s::CairoScript,r::CairoSurface)
    ccall((:cairo_script_from_recording_surface,_jl_libcairo), Int32,
                (Ptr{Cvoid},Ptr{Cvoid}),s.ptr, r.ptr)
end
# -----------------------------------------------------------------------------
...
mutable struct CairoContext <: GraphicsContext
    ...
    function CairoContext(ptr::Ptr{Cvoid})
...
function destroy(ctx::CairoContext)
    ...
    ccall((:g_object_unref,_jl_libgobject), Nothing, (Ptr{Cvoid},), ctx.layout)
    _destroy(ctx)
    ctx.ptr = C_NULL
    nothing
end
...
function stroke(ctx::CairoContext)
    ...
    reset_transform(ctx)
    ccall((:cairo_stroke, _jl_libcairo), Nothing, (Ptr{Cvoid},), ctx.ptr)
    restore(ctx)
end
...
function stroke_preserve(ctx::CairoContext)
    save(ctx)
    reset_transform(ctx)
    ccall((:cairo_stroke_preserve, _jl_libcairo), Nothing, (Ptr{Cvoid},), ctx.ptr)
    restore(ctx)
end

function paint_with_alpha(ctx::CairoContext, a)
    ccall((:cairo_paint_with_alpha, _jl_libcairo),
          Nothing, (Ptr{Cvoid}, Float64), ctx.ptr, a)
end

function get_operator(ctx::CairoContext)
    @compat Int(ccall((:cairo_get_operator,_jl_libcairo), Int32, (Ptr{Cvoid},), ctx.ptr))
end
...
for (NAME, FUNCTION) in Any[(:set_fill_type, :cairo_set_fill_rule),
    ...
    @eval begin
        $NAME(ctx::CairoContext, i0::Integer) =
            ccall(($(Expr(:quote,FUNCTION)),_jl_libcairo),
                  Nothing, (Ptr{Cvoid},Int32), ctx.ptr, i0)
    end
end
...
for (NAME, FUNCTION) in Any[(:set_line_width, :cairo_set_line_width),
    ...
    @eval begin
        $NAME(ctx::CairoContext, d0::Real) =
            ccall(($(Expr(:quote,FUNCTION)),_jl_libcairo),
                  Nothing, (Ptr{Cvoid},Float64), ctx.ptr, d0)
    end
end
...
for (NAME, FUNCTION) in Any[(:line_to, :cairo_line_to),
    ...
    @eval begin
        $NAME(ctx::CairoContext, d0::Real, d1::Real) =
            ccall(($(Expr(:quote,FUNCTION)),_jl_libcairo),
                  Nothing, (Ptr{Cvoid},Float64,Float64), ctx.ptr, d0, d1)
    end
end
...
for (NAME, FUNCTION) in Any[(:curve_to, :cairo_curve_to),
    ...
    @eval begin
        $NAME(ctx::CairoContext, d0::Real, d1::Real, d2::Real, d3::Real, d4::Real, d5::Real) =
            ccall(($(Expr(:quote,FUNCTION)),_jl_libcairo),
                  Nothing, (Ptr{Cvoid},Float64,Float64,Float64,Float64,Float64,Float64), ctx.ptr, d0, d1, d2, d3, d4, d5)
    end
end
...
for (NAME, FUNCTION) in Any[(:arc, :cairo_arc),
    ...
    @eval begin
        $NAME(ctx::CairoContext, xc::Real, yc::Real, radius::Real, angle1::Real, angle2::Real) =
            ccall(($(Expr(:quote,FUNCTION)),_jl_libcairo),
                  Nothing, (Ptr{Cvoid},Float64,Float64,Float64,Float64,Float64),
...
function set_dash(ctx::CairoContext, dashes::Vector{Float64}, offset::Real = 0.0)
    ccall((:cairo_set_dash,_jl_libcairo), Nothing,
          (Ptr{Cvoid},Ptr{Float64},Int32,Float64), ctx.ptr, dashes, length(dashes), offset)
end
...
function set_source_surface(ctx::CairoContext, s::CairoSurface, x::Real = 0.0, y::Real = 0.0)
    ccall((:cairo_set_source_surface,_jl_libcairo), Nothing,
          (Ptr{Cvoid},Ptr{Cvoid},Float64,Float64), ctx.ptr, s.ptr, x, y)
end
...
mutable struct CairoPath <: GraphicsDevice
    ...
    function CairoPath(ptr::Ptr{Cvoid})
        self = new(ptr)
        @compat finalizer(destroy, self)
        self
    end
...
function destroy(path::CairoPath)
    ...
    ccall((:cairo_path_destroy,_jl_libcairo), Nothing, (Ptr{Cvoid},), path.ptr)
    path.ptr = C_NULL
    nothing
end
    ...
    @eval begin
        function ($fname)(ctx::CairoContext, p::Vector{Float64})
            ccall(($(Expr(:quote,cname)),_jl_libcairo),
                  Nothing, (Ptr{Cvoid}, Ptr{Float64}, Ptr{Float64}),
...
function push_group(ctx::CairoContext)
    ...
    ccall((:cairo_push_group, _jl_libcairo), Nothing, (Ptr{Cvoid},),ctx.ptr)
    nothing
end
...
function pop_group(ctx::CairoContext)
    ...
    ptr = ccall((:cairo_pop_group, _jl_libcairo), Ptr{Cvoid}, (Ptr{Cvoid},),ctx.ptr)
...
set_source(dest::CairoContext, src::CairoPattern) =
    ccall((:cairo_set_source, _jl_libcairo),
          Nothing, (Ptr{Cvoid}, Ptr{Cvoid}), dest.ptr, src.ptr)
...
function pattern_create_radial(cx0::Real, cy0::Real, radius0::Real, cx1::Real, cy1::Real, radius1::Real)
    ptr = ccall((:cairo_pattern_create_radial, _jl_libcairo),
                    Ptr{Cvoid}, (Float64,Float64,Float64,Float64,Float64,Float64),cx0,cy0,radius0,cx1,cy1,radius1)
    pattern = CairoPattern(ptr)
    @compat finalizer(destroy, pattern)
    pattern
end
...
function pattern_create_linear(x0::Real, y0::Real, x1::Real, y1::Real)
    ptr = ccall((:cairo_pattern_create_linear, _jl_libcairo),
                    Ptr{Cvoid}, (Float64,Float64,Float64,Float64),x0,y0,x1,y1)
    pattern = CairoPattern(ptr)
    @compat finalizer(destroy, pattern)
    pattern
end
...
function pattern_add_color_stop_rgb(pat::CairoPattern, offset::Real, red::Real, green::Real, blue::Real)
    ccall((:cairo_pattern_add_color_stop_rgb, _jl_libcairo),
                    Nothing, (Ptr{Cvoid},Float64,Float64,Float64,Float64),pat.ptr,offset,red,green,blue)
end
...
function pattern_add_color_stop_rgba(pat::CairoPattern, offset::Real, red::Real, green::Real, blue::Real, alpha::Real)
    ccall((:cairo_pattern_add_color_stop_rgba, _jl_libcairo),
                    Nothing, (Ptr{Cvoid},Float64,Float64,Float64,Float64,Float64),pat.ptr,offset,red,green,blue,alpha)
end
...
function pattern_get_surface(pat::CairoPattern)
    ...
    status = ccall((:cairo_pattern_get_surface, _jl_libcairo), Cint,
                   (Ptr{Cvoid}, Ref{Ptr{Cvoid}}), pat.ptr, ptrref)
    if status == STATUS_PATTERN_TYPE_MISMATCH
        error("Cannot get surface from a non-surface pattern.")
    end
    ptr = ptrref.x

    ccall((:cairo_surface_reference, _jl_libcairo), Ptr{Cvoid}, (Ptr{Cvoid},), ptr)
    typ = ccall((:cairo_surface_get_type, _jl_libcairo), Cint, (Ptr{Cvoid},), ptr)
...
function destroy(pat::CairoPattern)
    ...
    ccall((:cairo_pattern_destroy,_jl_libcairo), Nothing, (Ptr{Cvoid},), pat.ptr)
    pat.ptr = C_NULL
    nothing
end
...
for (NAME, FUNCTION) in Any[(:mesh_pattern_line_to, :cairo_mesh_pattern_line_to),
    ...
    @eval begin
        $NAME(pattern::CairoPattern, d0::Real, d1::Real) =
            ccall(($(Expr(:quote,FUNCTION)),_jl_libcairo),
                  Nothing, (Ptr{Cvoid},Float64,Float64), pattern.ptr, d0, d1)
    end
end
...
for (NAME, FUNCTION) in Any[(:mesh_pattern_curve_to, :cairo_mesh_pattern_curve_to)]
    ...
    @eval begin
        $NAME(pattern::CairoPattern, d0::Real, d1::Real, d2::Real, d3::Real, d4::Real, d5::Real) =
            ccall(($(Expr(:quote,FUNCTION)),_jl_libcairo),
                  Nothing, (Ptr{Cvoid},Float64,Float64,Float64,Float64,Float64,Float64), pattern.ptr, d0, d1, d2, d3, d4, d5)
    end
end
...
function mesh_pattern_set_corner_color_rgb(pat::CairoPattern, corner_num::Real, red::Real, green::Real, blue::Real)
    ccall((:cairo_mesh_pattern_set_corner_color_rgb, _jl_libcairo),
                    Nothing, (Ptr{Cvoid},Int32,Float64,Float64,Float64),pat.ptr,corner_num,red,green,blue)
end
...
function mesh_pattern_set_corner_color_rgba(pat::CairoPattern, corner_num::Real, red::Real, green::Real, blue::Real, alpha::Real)
    ccall((:cairo_mesh_pattern_set_corner_color_rgba, _jl_libcairo),
                    Nothing, (Ptr{Cvoid},Int32,Float64,Float64,Float64,Float64),pat.ptr,corner_num,red,green,blue,alpha)
end
...
function get_matrix(ctx::CairoContext)
    m = [CairoMatrix()]
    ccall((:cairo_get_matrix, _jl_libcairo), Nothing, (Ptr{Cvoid}, Ptr{Cvoid}), ctx.ptr, m)
    m[1]
end

function set_matrix(ctx::CairoContext, m::CairoMatrix)
    ccall((:cairo_set_matrix, _jl_libcairo), Nothing, (Ptr{Cvoid}, Ptr{Cvoid}), ctx.ptr, [m])
end

function set_matrix(p::CairoPattern, m::CairoMatrix)
    ccall((:cairo_pattern_set_matrix, _jl_libcairo), Nothing, (Ptr{Cvoid}, Ptr{Cvoid}), p.ptr, [m])
end
...
function set_font_face(ctx::CairoContext, str::AbstractString)
    fontdesc = ccall((:pango_font_description_from_string,_jl_libpango),
                     Ptr{Cvoid}, (Ptr{UInt8},), @compat(String(str)))
    ccall((:pango_layout_set_font_description,_jl_libpango), Nothing,
          (Ptr{Cvoid},Ptr{Cvoid}), ctx.layout, fontdesc)
...
function set_text(ctx::CairoContext, text::AbstractString, markup::Bool = false)
    if markup
        ccall((:pango_layout_set_markup,_jl_libpango), Nothing,
            (Ptr{Cvoid},Ptr{UInt8},Int32), ctx.layout, @compat(String(text)), -1)
    else
...
function get_layout_size(ctx::CairoContext)
    ...
    ccall((:pango_layout_get_pixel_size,_jl_libpango), Nothing,
          (Ptr{Cvoid},Ptr{Int32},Ptr{Int32}), ctx.layout, pointer(w,1), pointer(w,2))
    w
end

function update_layout(ctx::CairoContext)
    ccall((:pango_cairo_update_layout,_jl_libpangocairo), Nothing,
          (Ptr{Cvoid},Ptr{Cvoid}), ctx.ptr, ctx.layout)
end
...
function text_extents!(ctx::CairoContext,value::AbstractString,extents)
    ccall((:cairo_text_extents, _jl_libcairo),
          Nothing, (Ptr{Cvoid}, Ptr{UInt8}, Ptr{Float64}),
...
function path_extents(ctx::CairoContext)
    ...
    ccall((:cairo_path_extents, _jl_libcairo),
          Nothing, (Ptr{Cvoid}, Ptr{Cdouble}, Ptr{Cdouble},
...
@deprecate cairo_write_to_ios_callback(s::Ptr{Cvoid}, buf::Ptr{UInt8}, len::UInt32)   write_to_ios_callback(s, buf, len)

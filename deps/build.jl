...
deps = [
    ...
    gobject = library_dependency("gobject", aliases = ["libgobject-2.0-0", "libgobject-2.0", "libgobject-2_0-0"], depends=[libffi, gettext], group = group)
...
@windows_only begin
    ...
    provides(WinRPM.RPM,"zlib1",zlib,os = :Windows)
